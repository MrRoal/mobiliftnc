...
* Description: ModelTheme Framework required by Zidex Theme.
* Version: 1.5
* Author: ModelTheme
...
function modeltheme_dashboard_widgets() {
    ...
    // wp_add_dashboard_widget('modeltheme_ads_widget', 'Best Offer', 'modeltheme_custom_dashboard_ads');
}
...
require_once('inc/sb-google-maps-vc-addon/sb-google-maps-vc-addon.php'); // CUSTOM FUNCTIONS
...
function modeltheme_framework() {
    ...
    // wp_enqueue_script( 'instafeed', plugin_dir_url( __FILE__ ) . 'js/instafeed.min.js', array('jquery'), '1.0.0', true );
