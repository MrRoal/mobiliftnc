    ...
    function wbc_extended_example( $demo_active_import , $demo_directory_path ) {
        ...
        */
        ...
        if ( class_exists( 'RevSlider' ) ) {
            $wbc_sliders_array = array(
                'Main Home' => array('slider1_zidex.zip'),
                'Home Beer Factory' => array('home-beer-factory.zip'),
                'Home Beer Factory Video' => array('home-beer-factory-video.zip'),
                'Home Car Factory' => array('home-car-factory.zip'),
                'Home Construction' => array('home-car-factory.zip'),
                'Home Electric Factory' => array('home-electric-factory.zip'),
                'Home Engineer' => array('home-electric-factory.zip'),
                'Home Parallax' => array(''),
                'Home Ship Factory' => array('home-ship-factory.zip'),
                'Home Plane Factory' => array('home-plane-factory.zip'),
                'Home Slider 2' => array('slider2_zidex.zip'),
                'Home Smart Robotics' => array('home-smart-robotics.zip'),
                'Home Video' => array('home-video-zidex.zip'),
                'Home Video 2' => array('slider3_zidex.zip'),
                'Home Electronics' => array('home-electronics.zip'),
                'Home Pharmaceuticals' => array('home-pharmaceuticals.zip'),
                'Home Medical Mask Factory' => array('home-medical-mask-factory.zip'),
            );
        ...
        *************************************************************************/
        ...
        $wbc_menu_array = array( 
            'Main Home',
            'Home Beer Factory',
            'Home Beer Factory Video',
            'Home Car Factory',
            'Home Construction',
            'Home Electric Factory',
            'Home Engineer',
            'Home Ship Factory',
            'Home Parallax',
            'Home Plane Factory',
        ...
        */
        ...
        $wbc_home_pages = array(
            'Main Home'                     => 'Home',
            'Home Beer Factory'             => 'Home Beer Factory',
            'Home Beer Factory Video'       => 'Home Beer Factory Video',
            'Home Car Factory'              => 'Home Car Factory',
            'Home Construction'             => 'Home Construction',
            'Home Electric Factory'         => 'Home Electric Factory',
            'Home Engineer'                 => 'Home Engineer',
            'Home Parallax'                 => 'Home Parallax',
            'Home Plane Factory'            => 'Home Plane Factory',
            'Home Slider 2'                 => 'Home Slider 2',
            'Home Smart Robotics'           => 'Home Smart Robotics',
            'Home Ship Factory'             => 'Home Ship Factory',
            'Home Electronics'              => 'Home Electronics',
            'Home Pharmaceuticals'          => 'Home Pharmaceuticals',
            'Home Medical Mask Factory'     => 'Home Medical Mask Factory',
        );
