...
if (is_plugin_active('redux-framework/redux-framework.php')){
    ...
    function modeltheme_setup_shortcode_tweetslider( $params, $content ) {
        ...
        $tw_username            = $zidex_redux['mt_social_tw'];
        $consumer_key           = $zidex_redux['mt_tw_consumer_key'];
        $consumer_secret        = $zidex_redux['mt_tw_consumer_secret'];
        $access_token           = $zidex_redux['mt_tw_access_token'];
        $access_token_secret    = $zidex_redux['mt_tw_access_token_secret'];
        $no = $no+1;
