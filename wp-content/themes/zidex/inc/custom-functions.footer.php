...
/**
Function name:              zidex_footer_row1()
Function description:       Footer row 1
*/
function zidex_footer_row1(){
    ...
    if ( class_exists( 'ReduxFrameworkPlugin' ) ) {
        echo '<div class="row">';
            echo '<div class="col-md-12 footer-row-1">';
                ...
                $footer_row_1_layout = $zidex_redux['mt_footer_row_1_layout'];
                $nr = array("1", "2", "3", "4", "6");
                ...
                if (in_array($footer_row_1_layout, $nr)) {
                ...
                }elseif($footer_row_1_layout == 'column_5_2_2_3'){
                    if ( is_active_sidebar( 'footer_row_1_1' ) ){
                        echo '<div class="col-md-5 sidebar-1">';
                            dynamic_sidebar( 'footer_row_1_1' );
                        echo '</div>';
                    }
                ...
                }elseif($footer_row_1_layout == 'column_2_10'){
                    if ( is_active_sidebar( 'footer_row_1_1' ) ){
                        echo '<div class="col-md-4 sidebar-1">';
                            dynamic_sidebar( 'footer_row_1_1' );
                        echo '</div>';
                    ...
                    if ( is_active_sidebar( 'footer_row_1_2' ) ){
                        echo '<div class="col-md-8 sidebar-2">';
                            dynamic_sidebar( 'footer_row_1_2' );
                        echo '</div>';
                    }
                }
...
/**
Function name:              zidex_footer_row2()
Function description:       Footer row 2
*/
function zidex_footer_row2(){
    ...
    if ( class_exists( 'ReduxFrameworkPlugin' ) ) {
        echo '<div class="row">';
            echo '<div class="col-md-12 footer-row-2">';
                ...
                $footer_row_2_layout = $zidex_redux['mt_footer_row_2_layout'];
                $nr = array("1", "2", "3", "4", "6");
                ...
                if (in_array($footer_row_2_layout, $nr)) {
                ...
                }elseif($footer_row_2_layout == 'column_5_2_2_3'){
                    if ( is_active_sidebar( 'footer_row_2_1' ) ){
                        echo '<div class="col-md-5 sidebar-1">';
                            dynamic_sidebar( 'footer_row_2_1' );
                        echo '</div>';
                ...
                }elseif($footer_row_2_layout == 'column_2_10'){
                    if ( is_active_sidebar( 'footer_row_1_1' ) ){
                        echo '<div class="col-md-3 sidebar-1">';
                            dynamic_sidebar( 'footer_row_2_1' );
                        echo '</div>';
                    ...
                    if ( is_active_sidebar( 'footer_row_1_2' ) ){
                        echo '<div class="col-md-9 sidebar-2">';
                            dynamic_sidebar( 'footer_row_2_2' );
                        echo '</div>';
                    }
                }
...
/**
Function name:              zidex_footer_row3()
Function description:       Footer row 3
*/
function zidex_footer_row3(){
    ...
    if ( class_exists( 'ReduxFrameworkPlugin' ) ) {
        echo '<div class="row">';
            echo '<div class="col-md-12 footer-row-3">';
                ...
                $footer_row_3_layout = $zidex_redux['mt_footer_row_3_layout'];
                $nr = array("1", "2", "3", "4", "6");
                ...
                }elseif($footer_row_3_layout == 'column_5_2_2_3'){
                    if ( is_active_sidebar( 'footer_row_3_1' ) ){
                        echo '<div class="col-md-5 sidebar-1">';
                            dynamic_sidebar( 'footer_row_3_1' );
                        echo '</div>';
                ...
                }elseif($footer_row_3_layout == 'column_2_10'){
                    if ( is_active_sidebar( 'footer_row_1_1' ) ){
                        echo '<div class="col-md-3 sidebar-1">';
                            dynamic_sidebar( 'footer_row_3_1' );
                        echo '</div>';
