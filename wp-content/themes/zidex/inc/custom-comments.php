...
function zidex_custom_comments($comment, $args, $depth) {
...
?>
    ...
    <div id="div-comment-<?php comment_ID() ?>" class="comment-body fullwidth single_comment parent">
        ...
        <?php if ( $comment->comment_approved == '0' ) : ?>
            <em class="comment-awaiting-moderation"><?php esc_html_e( 'Your comment is awaiting moderation.','zidex' ); ?></em>
        <?php endif; ?>
        ...
        <div class="comment-meta commentmetadata col-md-11 col-xs-10 comment_body relative">
            <div class="vc_row">
                ...
                <span class="reply_button col-md-7 text-right">
                    <?php printf( '%1$s at %2$s', get_comment_date(get_option('date_format')),  get_comment_time() ); ?>
                </span>
            </div>
            <p><?php comment_text(); ?></p>
            <span class="reply_button1 col-md-4 text-left">
                <?php edit_comment_link( esc_html__( 'Edit', 'zidex' ), '  ', '' ); ?>
