...
$class_row = "col-md-8 vc_col-sm-8";
if ( zidex_redux('mt_blog_layout') == 'mt_blog_fullwidth' ) {
    $class_row = "col-md-12 vc_col-sm-12";
            ...
            <div class="row">
                ...
                <?php if ( zidex_redux('mt_blog_layout') != '' && zidex_redux('mt_blog_layout') == 'mt_blog_left_sidebar') { ?>
                    <?php if (is_active_sidebar($sidebar)) { ?>
                        <div class="col-md-4 vc_col-sm-4 sidebar-content sidebar-left"><?php  dynamic_sidebar( $sidebar ); ?></div>
                    <?php } ?>
                <?php } ?>
                        ...
                        <div class="row">
                            ...
                            <?php while ( have_posts() ) : the_post(); ?>
                                ...
                                if(get_post_format() == 'quote'){
                                    ...
                                    get_template_part( 'template-parts/content', $theme_init->zidex_blogloop_variant() );
                                }
                                ?>
                            <?php endwhile; ?>
